...
app_google = Blueprint('app_google', __name__)
...
def index2():
    if is_logged_in():
        ...
        return 'You are currently logged in as ' + user_info['given_name'] + str(user_info)
...
def google_auth_redirect():
    ...
    flask.session['username'] = get_user_info()['email']
    flask.session['given_name'] = get_user_info()['given_name']
    flask.session['family_name'] = get_user_info()['family_name']
